package ca.shoaib.weather.data;
/*
...
public class WeatherContract {
    ...
    // device.
    public static final String CONTENT_AUTHORITY = "ca.shoaib.weather";
    ...
    public static final class LocationEntry implements BaseColumns {
        ...
        // In order to uniquely pin point the location on the map,
        // we save the location coords
